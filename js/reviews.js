...
const Reviews = {
  ...
  renderWidget(containerId) {
    ...
    const allReviews = [
      ...
      { name: 'David & Lisa K.', rating: 5, text: 'The off-the-beaten-path spots in our itinerary were incredible. Perfect for our family and we felt like locals the whole time.', tripType: '5-day family trip', date: '2026-01-20' },
